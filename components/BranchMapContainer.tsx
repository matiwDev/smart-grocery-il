...
export function BranchMapContainer({ city, lang, liveBranches, activeMapPin, setActiveMapPin, preferredChainId, t }: BranchMapContainerProps) {
         ...
         {sortedBranches.map(b => (
           ...
           >
             <div className="flex items-center gap-4">
               <div className="w-3 h-3 rounded-full shrink-0" style={{ backgroundColor: b.color_hex }} />
